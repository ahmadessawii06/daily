    ...
    <div className="space-y-3.5">
      ...
      <div className="flex flex-col gap-3 pt-2">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5">
          ...
          {/* Quick Filter tabs */}
          <div className="flex items-center p-1 bg-slate-100 dark:bg-[#10121a] border border-slate-200 dark:border-white/[0.08] rounded-xl text-xs font-semibold overflow-x-auto no-scrollbar max-w-full">
            <button
              type="button"
              onClick={() => onFilterChange('all')}
              className={`px-2.5 sm:px-3 py-1.5 rounded-lg transition-all cursor-pointer whitespace-nowrap min-h-[32px] flex items-center gap-1 ${
                currentFilter === 'all'
            ...
            <button
              ...
              className={`px-2.5 sm:px-3 py-1.5 rounded-lg transition-all cursor-pointer whitespace-nowrap min-h-[32px] flex items-center ${
                currentFilter === 'done'
          ...
          <div className="relative w-full sm:w-48">
            ...
            <input
              ...
              className="bg-white dark:bg-[#10121a] border border-slate-200 dark:border-white/[0.08] rounded-xl ps-8 pe-3 py-2 text-xs font-medium text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-zinc-500 focus:outline-none focus:border-emerald-500 shadow-2xs w-full transition-all min-h-[36px]"
            />
          </div>
