  ...
  return (
    <div className="space-y-3.5">
      ...
      {filteredTasks.length === 0 ? (
        <div className="py-14 sm:py-16 px-4 text-center border border-dashed border-slate-200 dark:border-white/[0.1] rounded-3xl bg-white/70 dark:bg-gradient-to-b dark:from-white/[0.02] dark:to-transparent relative overflow-hidden shadow-2xs">
          {tasks.length === 0 ? (
            <div className="max-w-sm mx-auto space-y-4">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 text-xs font-bold text-slate-950 bg-slate-900 text-white hover:bg-slate-800 dark:bg-white dark:text-slate-950 dark:hover:bg-zinc-200 rounded-xl transition-all shadow-md active:scale-98 cursor-pointer"
                >
