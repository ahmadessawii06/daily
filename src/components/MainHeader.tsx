      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-2 text-xs sm:text-sm font-bold text-emerald-950 bg-emerald-400 hover:bg-emerald-300 active:scale-98 rounded-xl transition-all shadow-xs hover:shadow-sm cursor-pointer min-h-[36px] font-['Alexandria']"
          >
