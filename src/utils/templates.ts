...
export const SCHEDULE_TEMPLATES: ScheduleTemplate[] = [
  {
    id: 'saturday-university',
    nameAr: 'جدول السبت والدوام الجامعي',
    nameEn: 'Saturday University Routine',
    descriptionAr: 'الجدول الكامل للدوام والمحاضرات الستة، والصلوات في وقتها، مع أوقات البريك والدراسة المسائية.',
    descriptionEn: 'Full 24-hour daily routine: 6 university lectures, daily prayers, evening study, and leisure blocks.',
    icon: 'GraduationCap',
    categoryTag: 'study',
    tasks: [
      { time: '00:00', endTime: '01:00', duration: 60, title: 'نوم', status: 'pending', category: 'sleep' },
      { time: '01:00', endTime: '02:00', duration: 60, title: 'نوم', status: 'pending', category: 'sleep' },
      { time: '02:00', endTime: '03:00', duration: 60, title: 'نوم', status: 'pending', category: 'sleep' },
      { time: '03:00', endTime: '04:00', duration: 60, title: 'نوم', status: 'pending', category: 'sleep' },
      { time: '04:00', endTime: '05:00', duration: 60, title: 'نوم', status: 'pending', category: 'sleep' },
      { time: '05:00', endTime: '06:00', duration: 60, title: 'صلاة الفجر', status: 'pending', category: 'worship' },
      { time: '06:00', endTime: '07:00', duration: 60, title: 'الأذكار + الورد اليومي', status: 'pending', category: 'worship' },
      { time: '07:00', endTime: '08:00', duration: 60, title: 'التجهيز للدوام', status: 'pending', category: 'health' },
      { time: '08:00', endTime: '09:00', duration: 60, title: 'محاضرة 1', status: 'pending', category: 'study' },
      { time: '09:00', endTime: '10:00', duration: 60, title: 'محاضرة 1', status: 'pending', category: 'study' },
      { time: '10:00', endTime: '11:00', duration: 60, title: 'محاضرة 2', status: 'pending', category: 'study' },
      { time: '11:00', endTime: '12:00', duration: 60, title: 'محاضرة 3', status: 'pending', category: 'study' },
      { time: '12:00', endTime: '13:00', duration: 60, title: 'محاضرة 4 + صلاة الظهر', status: 'pending', category: 'study' },
      { time: '13:00', endTime: '14:00', duration: 60, title: 'محاضرة 5', status: 'pending', category: 'study' },
      { time: '14:00', endTime: '15:00', duration: 60, title: 'محاضرة 6', status: 'pending', category: 'study' },
      { time: '15:00', endTime: '16:00', duration: 60, title: 'فطور + صلاة العصر', status: 'pending', category: 'health' },
      { time: '16:00', endTime: '17:00', duration: 60, title: 'بريك', status: 'pending', category: 'rest' },
      { time: '17:00', endTime: '18:00', duration: 60, title: 'مواصلات', status: 'pending', category: 'general' },
      { time: '18:00', endTime: '19:00', duration: 60, title: 'دراسة محاضرة استرجاع + صلاة المغرب', status: 'pending', category: 'study' },
      { time: '19:00', endTime: '20:00', duration: 60, title: 'دراسة محاضرة استرجاع + صلاة العشاء', status: 'pending', category: 'study' },
      { time: '20:00', endTime: '21:00', duration: 60, title: 'بريك ماينكرافت لايف 1', status: 'pending', category: 'rest' },
      { time: '21:00', endTime: '22:00', duration: 60, title: 'بريك ماينكرافت لايف 2', status: 'pending', category: 'rest' },
      { time: '22:00', endTime: '23:00', duration: 60, title: 'فقرة الأدعية', status: 'pending', category: 'worship' },
      { time: '23:00', endTime: '00:00', duration: 60, title: 'نوم', status: 'pending', category: 'sleep' },
    ],
  },
  {
    id: 'study-day',
